...
async def ping(client, m: Message):
   ...
   await m_reply.edit(f"**┞◈𝗣𝗼𝗻𝗴!! MusicRoyUserbot🏓**\n**┞◈Pinger**  - {delta_ping * 1000:.3f} ms \n**┞◈Uptime** - {uptime}")
...
async def restart(client, m: Message):
    ...
    await loli.edit("8")
    await loli.edit("9")
    await loli.edit("**✅ Roy Music Userbot Di Restart Ulang**")
...
async def repo(client, m: Message):
    await m.delete()
    REPO = f"""
<b>👋 Hii {m.from_user.mention}!
🗃️ Music Dan Video Player UserBot
🔰 Telegram UserBot Untuk Memutar Lagu Dan Video Di Obrolan Suara Telegram.
👩‍💻 Maintaned By 
• [roy](https://t.me/Yorizt)
📝 Persyaratan
• Python 3.8+
• FFMPEG
• Nodejs v16+
[Repo VC-Userbot](https://github.com/kontolkeboo13/VC-Userbot)
